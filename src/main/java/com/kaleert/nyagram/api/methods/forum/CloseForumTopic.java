...
/**
 * Используйте этот метод для закрытия открытого топика (ветки) в супергруппе-форуме.
 * <p>
...
public class CloseForumTopic extends BotApiMethodBoolean {
    ...
    /**
     * Создает запрос на закрытие топика.
     *
     * @param chatId ID чата.
     * @param messageThreadId ID топика.
     * @return готовый объект запроса.
     */
    public static CloseForumTopic of(Long chatId, Integer messageThreadId) {
        return CloseForumTopic.builder()
