...
/**
 * Используйте этот метод для повторного открытия закрытого топика.
 * <p>
...
public class ReopenForumTopic extends BotApiMethodBoolean {
    ...
    /**
     * Создает запрос на повторное открытие закрытого топика.
     *
     * @param chatId ID чата.
     * @param messageThreadId ID топика.
     * @return готовый объект запроса.
     */
    public static ReopenForumTopic of(Long chatId, Integer messageThreadId) {
        return ReopenForumTopic.builder()
